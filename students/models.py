...
from students.validators import phone_number_validator, AdultValidator
...
class Student(models.Model):
    ...
    birthday = models.DateField(default=datetime.date.today, validators=[AdultValidator(20)])
